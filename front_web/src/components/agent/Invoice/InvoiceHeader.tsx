...
function InvoiceHeader({onCancel, invoiceNumber, customer, setCustomer, addProduct, onValidInvoice, errorVal, setErrorVal }: InvoiceHeaderProps) {
    ...
    <Box sx={{ position: 'relative' }}>
      <Box
        sx={{
          ...
          color: 'white',
          background: 'linear-gradient(90deg, #5f0bad 0%, #b412d4 55%, #d017f5 100%)',
        ...
        <Box
          ...
          <Button
            ...
            sx={{
              ...
              '&:hover': { backgroundColor: '#f77dfc' },
              boxShadow: '0 8px 18px rgba(129, 24, 120, 0.3)',
            }}
          >
            VALIDER
          </Button>
