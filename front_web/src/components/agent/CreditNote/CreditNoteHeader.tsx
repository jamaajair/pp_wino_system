...
interface CreditNoteHeaderProps {
  ...
  onValidCreditNote : () => void;
  errorVal : string | null;
  setErrorVal : (value: string | null) => void;
}

function CreditNoteHeader({onCancel, CreditNoteNumber, customer, setCustomer, addProduct, onValidCreditNote, errorVal, setErrorVal }: CreditNoteHeaderProps) {
    ...
    <Box sx={{ position: 'relative' }}>
      <Box
        sx={{
          ...
          color: 'white',
          background: 'linear-gradient(90deg, #329b43 0%, #1eb14f 55%, #72eb78 100%)',
        ...
        <Box 
          ...
          <Button
            ...
            sx={{
              ...
              color: '#6b7280',
              backgroundColor: 'white',
              '&:hover': { borderColor: '#b8c2d6', backgroundColor: '#00ffdd' },
            }}
          >
            ABANDONNER
          </Button>
