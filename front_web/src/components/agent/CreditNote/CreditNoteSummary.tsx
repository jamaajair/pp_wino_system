import type { CreditNoteItem } from "./NewCreditNote";
...
function CreditNoteSummary({ items }: CreditNoteSummaryProps) {
        ...
        <Box sx={{
            ...
            <Box sx={{ display: "flex", gap: 4 }}>
                ...
                <Box sx={{ textAlign: "right" }}>
                    ...
                    <Typography variant="h6" fontWeight={500} color="#028a14d8">{total_ttc.toFixed(2)} €</Typography>
                </Box>
            </Box>
